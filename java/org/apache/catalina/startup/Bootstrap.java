...
public final class Bootstrap {
    ...
    public void init() throws Exception {
        ...
        //设置Catalina实例的父类加载器 setParentClassLoader 为 sharedLoader
    ...
    private void load(String[] arguments)
        throws Exception {//反射调用的catalina实例的load方法
     ...
     */
    public void start()
        throws Exception {//反射调用catalina实例的start方法
     ...
     */
    public void stop()
        throws Exception {//catalina实例 stop
   ...
   /**
    ...
    public void stopServer(String[] arguments)
        ...
        //invoke catalina实例的stopServer方法
        Method method =
